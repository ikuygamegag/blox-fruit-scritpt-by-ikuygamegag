--[=[ 
    ...
    คัดลอกโค้ดทั้งหมดนี้ไปวางทับในสคริปต์ของคุณได้เลย[cite: 2]
]=]
...
local moveTweenSpeed = 250 --[cite: 2]

-- -------------------------------------------------------
-- 3. Level & Quest Database (1 to 2800)[cite: 2]
-- -------------------------------------------------------
local QuestDatabase = {
...
-- ระบบ Teleport แบบ Tween (ความเร็ว 250 Studs/s)[cite: 2]
